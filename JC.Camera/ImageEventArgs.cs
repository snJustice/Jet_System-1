...
namespace JC.Camera
{
    ...
    public class ImageEventArgs : EventArgs, IDisposable
    {
        ...
        public readonly Cognex.VisionPro.CogImage8Grey CameraImage;
        ...
        public ImageEventArgs(Command command, Cognex.VisionPro.CogImage8Grey cameraImage, int cameraIndex, int settingIndex, double startTime)
        {
            Command = command;
            CameraImage = cameraImage;
            CameraIndex = cameraIndex;
