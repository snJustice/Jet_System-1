...
namespace JC.Camera
{
    public class HikvisionCamera : CameraBase
    {
        ...
        MyCamera.MV_CC_DEVICE_INFO device_Info;
        ...
        public override long ShuterCur
        {
            ...
            set
            {
                try
                {
                    ...
                    int nRet;
                    nRet = m_pOperator.SetFloatValue("ExposureTimeAbs", shutterValue);
                    if (nRet != CameraOperator.CO_OK)
                    {
                        throw new Exception("设置曝光时间失败！");
                    }
        ...
        public HikvisionCamera(CameraOperator m_pOperator, MyCamera.MV_CC_DEVICE_INFO _device_Info)
        {
            this.m_pOperator = m_pOperator;
        ...
        {
            this.m_pOperator = new CameraOperator();
        ...
        public override void ContinuousShot()
        {
            ...
            try
            {
                ...
                IsContinuousShot = true;
                 ...
                 m_pOperator.CommandExecute("AcquisitionStart");
        ...
        public override void ContinuousShotStop()
        {
            try
            {
                ...
                Console.WriteLine(m_pOperator.SetEnumValue("TriggerMode", 1));// 0-off,1-on
                ...
                //           4 - Counter;
                //           7 - Software;
                Console.WriteLine(m_pOperator.SetEnumValue("TriggerSource", 7));
                uint aaaa = new uint();
                m_pOperator.GetEnumValue("TriggerSource",ref aaaa);
        ...
        public override bool Open()
        {
            try
            {
                ...
                m_pOperator.Open(this.device_Info);
                ...
                IsLink = true;
                Console.WriteLine(m_pOperator.SetEnumValue("AcquisitionMode", 2));//lianxi
                //Thread.Sleep(500);
