...
namespace JC.Camera
{
    ...
    {
        protected Cognex.VisionPro.CogImage8Grey hPylonImage;
        ...
        protected void TrigerImageEvent()
        {
            ...
            if (hPylonImage != null )//&& hPylonImage.IsInitialized())
            {
                ...
                Cognex.VisionPro.CogImage8Grey imgTmp = RotateImage(hPylonImage);
            ...
            TrigerImageEvent(this, new ImageEventArgs(Command, hPylonImage, cameraIndex, startTime));
        }
        ...
        public abstract bool Open(string ip);
        /// <summary>
        /// 关闭设备
        /// </summary>
        ...
        public virtual Cognex.VisionPro.CogImage8Grey GrabImage(int delayMs)
        {
