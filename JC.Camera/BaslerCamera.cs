    ...
    public class BaslerCamera : CameraBase
    {
        ...
        public override bool Open()
        {
            try
            {
                ...
                Trace.WriteLine(g_camera.Parameters[PLCamera.GevSCPSPacketSize].TrySetValue(9196));
                
                Trace.WriteLine(g_camera.Parameters.Contains(PLCamera.PacketSize));
                //Trace.WriteLine(g_camera.Parameters[PLCamera.PacketSize].GetValue());
